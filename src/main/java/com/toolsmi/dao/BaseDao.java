...
public interface BaseDao {
	...
	<T> List<T> query_entities(String hql, Integer currentPage, Integer pageSize, Map<String, Object> map);

	<T> List<T> query_suitEntities(String hql, Map<String, Object> map);
